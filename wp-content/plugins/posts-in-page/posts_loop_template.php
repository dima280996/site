...
<div class="post hentry ivycat-post">
	...
	<div class="entry-utility">
		...
		<?php
			...
			<span class="meta-sep">|</span>
		<?php endif; ?>
		<span class="comments-link"><?php comments_popup_link( __( 'Залишити коментар', 'posts-in-page' ), __( '1 Comment', 'posts-in-page' ), __( '% Comments', 'posts-in-page' ) ); ?></span>
		<?php edit_post_link( __( 'Редагувати', 'posts-in-page' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
	</div>
</div>
<!-- // Post Wrap End -->
